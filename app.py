...
#     print("Started doing default route")
...
#     print("Initilizing from app side...")
...
#                 dynamic_questions = generate_dynamic_questions(text,'AIzaSyB_w0P92sNE8MaFibfPfZPkm4P3cO9Pt7Q')
...
#     socketio.emit('response_event', {'response': 'It works!'})
...
# @app.route('/test')
# def test_event():
#     socketio.emit('transcript', {'text': 'Test event triggered!'})
#     socketio.emit('analysis', {
#         'sentiment': 'positive',
#         'score': 0.9,
#         'shift': 'None',
#         'recommendations': ['Smartphone', 'Laptop'],
#         'questions': ['What is your budget?', 'Do you need a warranty?']
#     })
#     return "Test events emitted"
...
#     initialize_database()
#     os.makedirs("uploads", exist_ok=True)
#     socketio.run(app, debug=True, allow_unsafe_werkzeug=False)
